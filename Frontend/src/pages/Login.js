...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('userId', response.data.userId); // Almacenar el userId en el localStorage
        ...
        <div className="flex flex-col overflow-y-auto md:flex-row">
          ...
          <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              <Label>
                <span>Email</span>
                <Input className="mt-1" type="email" placeholder="john@doe.com" value={email}
